...
const pages = [
  { slug: 'eczema', lang: 'cs', title: 'Ekzém u dětí', description: 'Jak rozpoznat ekzém u dětí, co ho může zhoršovat a jak při hledání souvislostí pomáhá aplikace Bejby bez alergií.', input: 'content/cz/eczema_cz.md', output: 'eczema/index.html', hero: '/assets/article-eczema.jpg', nav: { app: 'Aplikace', eczema: 'Ekzém u dětí', signs: 'Projevy potravinové alergie', main: 'Eliminační dieta' } },
  { slug: 'signs', lang: 'cs', title: 'Projevy potravinové alergie', description: 'Přehled častých projevů potravinové alergie u dětí a signálů, které se vyplatí systematicky sledovat.', input: 'content/cz/signs_cz.md', output: 'signs/index.html', hero: '/assets/article-signs.png', nav: { app: 'Aplikace', eczema: 'Ekzém u dětí', signs: 'Projevy potravinové alergie', main: 'Eliminační dieta' } },
  { slug: 'main-suspects', lang: 'cs', title: 'Eliminační dieta', description: 'První fáze eliminační diety: hlavní podezřelé potraviny, co sledovat a jak postupovat přehledně.', input: 'content/cz/main_cz.md', output: 'main-suspects/index.html', hero: '/assets/article-main.jpg', nav: { app: 'Aplikace', eczema: 'Ekzém u dětí', signs: 'Projevy potravinové alergie', main: 'Eliminační dieta' } },
...
<main>
  ...
  <article class="article-content container">
    ...
    <section class="article-cta"><div><span>${isEn ? 'A clearer path for parents' : 'Přehlednější cesta pro rodiče'}</span><h2>${isEn ? 'Track foods and symptoms in one place' : 'Sledujte potraviny a projevy na jednom místě'}</h2></div><div class="store-links store-links--cta" aria-label="${isEn ? 'App download links' : 'Odkazy ke stažení aplikace'}"><a class="store-badge-link" href="https://play.google.com/store/apps/details?id=cz.babyapp.app&hl=${isEn ? 'en' : 'cs'}" target="_blank" rel="noopener noreferrer" aria-label="${isEn ? 'Get Baby w/o allergies on Google Play' : 'Stáhnout aplikaci Bejby bez alergií na Google Play'}"><img class="store-badge" src="/assets/google-play-badge-${isEn ? 'en' : 'cs'}.png" alt="${isEn ? 'Get it on Google Play' : 'Stáhnout na Google Play'}" loading="lazy" decoding="async"></a><a class="store-badge-link" href="https://apps.apple.com/cz/app/bejby-bez-alergi%C3%AD/id6776690582?l=${isEn ? 'en' : 'cs'}" target="_blank" rel="noopener noreferrer" aria-label="${isEn ? 'Download Baby w/o allergies on the App Store' : 'Stáhnout aplikaci Bejby bez alergií v App Storu'}"><img class="store-badge" src="/assets/app_store_badge_${isEn ? 'en' : 'cs'}.svg" alt="${isEn ? 'Download on the App Store' : 'Stáhnout v App Storu'}" loading="lazy" decoding="async"></a></div></section>
